...
class GetEstacioDireitoJob < ApplicationJob
  def perform
    get_admin
  end

  def get_admin
    doc = Nokogiri::HTML(URI.open('https://portal.estacio.br/cursos/mestrado-e-doutorado/direito/disserta%C3%A7%C3%B5es-e-teses/'))
